# XamarinMediaManagerRx Project for Mobile Applications
...
1. XamarinMediaManagerRx-Android: The main Android app project.
1. XamarinMediaManagerRx-iOS: The main iOS (both iPhone and iPad) application project.
1. XamarinMediaManagerRx-Core: Code that is shared between the two projects. This project
...
other) in the XamarinMediaManagerRx-Core library. 
...
Here are some things that belong in XamarinMediaManagerRx-Core:
...
So, it's important that XamarinMediaManagerRx-Core not do platform-specific things - if
you're talking about CGRects in a XamarinMediaManagerRx-Core class, you're Doing It Wrong™.

Here are some things that will end up in XamarinMediaManagerRx-{Platform}
...
1. Create a new ViewModel class in XamarinMediaManagerRx-Core and derive it from
